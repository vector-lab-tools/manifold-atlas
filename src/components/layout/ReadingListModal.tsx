    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[60] w-[560px] max-w-[90vw] max-h-[80vh] overflow-y-auto card-editorial shadow-editorial-lg animate-fade-in">
        ...
        <div className="px-6 py-5 space-y-3 font-body text-body-sm text-slate">
          ...
          <p className="border-l-2 border-burgundy pl-3">Berry, D.M. (2026) &lsquo;<a href="https://doi.org/10.1007/s13347-026-01162-w" target="_blank" rel="noopener noreferrer" className="text-burgundy underline underline-offset-2">Vector Theory: Epistemology, Political Economy, and Probabilistic Computation</a>&rsquo;, <em>Philosophy &amp; Technology</em>, 39(3), 149. <span className="text-muted-foreground">The theoretical basis for this instrument. Every operation here tests a claim made in this article.</span></p>
